...
public class PenVideoView extends SurfaceView implements MediaPlayerControl {
    private String TAG = "PenVideoView";
    ...
    public PenVideoView(MainActivity activity,int tag) {
        super(activity);
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mIsAssetRouse) {
                AssetFileDescriptor afd = mMainActivity.getAssets().openFd(mVideoFilePath);
                if (afd == null && PenHelper.getObbFile() != null) {
                    afd = PenHelper.getObbFile() .getAssetFileDescriptor(mVideoFilePath);
                }
                mMediaPlayer.setDataSource(afd.getFileDescriptor(),afd.getStartOffset(),afd.getLength());
            } else {
                mMediaPlayer.setDataSource(mMainActivity, mVideoUri);
            }
    ...
    private MediaPlayer.OnErrorListener mErrorListener =
        ...
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                Resources r = mMainActivity.getResources();
                int messageId;
