...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_com_jamar_pen_engine_PenSurfaceRenderer_nativeTouchesBegin(JNIEnv* env, jobject obj, jint id, jfloat x, jfloat y) {
        /*Click event*/
        pen::Pen::mobile_click_callback(pen::in::KEYS::MOUSE_LEFT, pen::in::KEYS::PRESSED, 0);
    }

    JNIEXPORT void JNICALL Java_com_jamar_pen_engine_PenSurfaceRenderer_nativeTouchesEnd(JNIEnv* env, jobject obj, jint id, jfloat x, jfloat y) {
        /*Release event*/
        pen::Pen::mobile_click_callback(pen::in::KEYS::MOUSE_LEFT, pen::in::KEYS::RELEASED, 0);
    }

    JNIEXPORT void JNICALL Java_com_jamar_pen_engine_PenSurfaceRenderer_nativeTouchesMove(JNIEnv* env, jobject obj, jintArray ids, jfloatArray xs, jfloatArray ys) {
        /*Handles drag events*/
    ...
    JNIEXPORT jboolean JNICALL Java_com_jamar_pen_engine_PenSurfaceRenderer_nativeKeyEvent(JNIEnv* env, jobject obj, jint keyCode, jboolean isPressed) {
        /*Initially override these key events such as the back key to do nothing*/
        return JNI_TRUE;
    }

    JNIEXPORT jboolean JNICALL Java_com_jamar_pen_engine_PenSurfaceRenderer_nativeOnKeyPress(JNIEnv* env, jobject obj, jstring javaCharacter, jboolean isPressed) {
    ...
    JNIEXPORT void JNICALL Java_com_jamar_pen_engine_PenAccelerometer_onSensorChanged(JNIEnv* env, jobject obj, jfloat x, jfloat y, jfloat z, jlong timeStamp) {
        /*Handle tilt events*/
