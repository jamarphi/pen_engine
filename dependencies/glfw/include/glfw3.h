 ...
 *  [window hint](@ref glfw_PEN_TRANSPARENT_FRAMEBUFFER_hint) and
 *  [window attribute](@ref glfw_PEN_TRANSPARENT_FRAMEBUFFER_attrib).
 */
#define glfw_PEN_TRANSPARENT_FRAMEBUFFER 0x0002000A
 ...
 *  of a few micro- or penseconds.  It uses the highest-resolution monotonic
 ...
 *  storing penseconds in 64 bits.  The limit may be increased in the future.
 *
 *  @thread_safety This function may be called from any thread.  Reading and
 *  writing of the internal base time is not atomic, so it needs to be
