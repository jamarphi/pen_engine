...
namespace pen {
	std::vector<pen::Animation3DItem> Animation3D::animList = {};

	void Animation3D::Add(pen::GraphicallyAcceleratedItem3D* item, const unsigned int& type, const long& ms, const bool& infinite, const float& unitA, const float& unitB, const float& unitC) {
