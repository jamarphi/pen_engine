...
namespace pen {
	namespace ui {
		class ScrollBar : public pen::ui::Item {
		public:
			ScrollBar();
			ScrollBar(uint32_t objectId, pen::Vec3 objectPositions, pen::Vec2 objectSize, pen::Vec4 objectColor = pen::Vec4(1.0f, 1.0f, 1.0f, 1.0f),
			...
			void VerticalListDrag(pen::ui::Item* item, double* xPos, double* yPos, const float& scrollTranslation);
		};
	}
}