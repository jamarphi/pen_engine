...
namespace pen {
    namespace ui {
        ...
        std::vector<float> Shape::GetBatchPosition(pen::Vec3 pos, pen::Vec2 size, unsigned int shapeType, pen::Vec4 color, float* oldPositions, const float& angleX, const float& angleY, const float& angleZ, float texId,
